    ...
    fetchGetData() {
      getUserStatistics().then(res => {
        if (res.code === 200 && res.data !== null) {
          ...
          // 今日新增用户
          this.baseList[3].userNums = appUserStatisticsVo.todayNewUser;
          this.baseList[3].iosNums = appUserStatisticsVo.iosTodayNewUser;
          this.baseList[3].androidNums = appUserStatisticsVo.azTodayNewUser;
          ...
          // 今日活跃注册用户
          this.baseList[5].userNums = appUserStatisticsVo.todayActiveUser;
          this.baseList[5].iosNums = appUserStatisticsVo.iosTodayActiveUser;
          this.baseList[5].androidNums = appUserStatisticsVo.azTodayActiveUser;

          // 昨日活跃注册用户
          this.baseList[6].userNums = appUserStatisticsVo.yesterdayActiveUser;
          this.baseList[6].iosNums = appUserStatisticsVo.iosYesterdayActiveUser;
          this.baseList[6].androidNums =
            appUserStatisticsVo.azYesterdayActiveUser;

          // 今日活跃游客用户
          this.baseList[7].userNums = appUserStatisticsVo.todayVisitorCount;
          this.baseList[7].iosNums = appUserStatisticsVo.iosTodayVisitorCount;
          this.baseList[7].androidNums =
            appUserStatisticsVo.azTodayVisitorCount;

          // 昨日活跃游客用户
          this.baseList[8].userNums = appUserStatisticsVo.yesterdayVisitorCount;
          this.baseList[8].iosNums =
            appUserStatisticsVo.iosYesterdayVisitorCount;
          this.baseList[8].androidNums =
            appUserStatisticsVo.azYesterdayVisitorCount;

          // 当前在线用户
          this.baseList[9].userNums = appUserStatisticsVo.onlineCount;
          this.baseList[9].iosNums = appUserStatisticsVo.iosonlineCount;
          this.baseList[9].androidNums = appUserStatisticsVo.azOnlineCount;
        }
      });
    },
