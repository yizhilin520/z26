      ...
      <div class="film_content">
        ...
        >
          <el-table-column
            ...
            width="60"
          />
          <el-table-column label="第三方订单号" prop="reqOrderId" align="center" />
          <el-table-column label="充值方式" align="center" prop="payChannel" />
          <el-table-column label="支付金额（元）" align="center" prop="money" />
...
<script>
import { callList, callExportList } from "@/api/recharge_api";
...
export default {
  ...
  methods: {
    ...
    async handleExport() {
      ...
      let res = await callExportList({ ...params });
