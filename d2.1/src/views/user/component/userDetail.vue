  ...
  <div v-if="userInfo" class="userdetails-container">
    <el-card shadow="never">
      ...
      <el-table
        ...
        size="mini"
      >
        <el-table-column label="抖币余额（个）" align="center" prop="goldNumber" />
        <el-table-column label="金币余额（个）" align="center" prop="balance" />
        <el-table-column label="累计充值金币数（个）" align="center" prop="sumRecharge" />
        <el-table-column label="累计消费金币数（个）" align="center" prop="consumGold" />
        <!-- <el-table-column label="购买影片数" align="center" prop="" /> -->
      </el-table>
      ...
      >
        ...
        <el-table-column label="收藏影片" align="center" prop="moveCollectNum" />
        <el-table-column label="收藏短视频" align="center" prop="praiseNum" />
        <el-table-column
          label="视频获赞"
          align="center"
          prop="videoPraiseNum"
      ...
      <el-table
        ...
        size="mini"
      >
        <el-table-column align="center" label="影片ID">
          <template slot-scope="scope">{{ scope.row.videoId }}</template>
        </el-table-column>
        <el-table-column align="center" label="影片封面" ></el-table-column>
        <el-table-column align="center" width="100" label="影片">
          <template slot-scope="scope">
            <el-image
              class="tb_image"
              :src="scope.row.videoImg"
        ...
        <el-table-column label="影片名称" align="center">
          <template slot-scope="scope">{{ scope.row.videoTitle }}</template>
        </el-table-column>
        <el-table-column label="购买日期" align="center">
          <template slot-scope="scope">{{ scope.row.publishTime }}</template>
        </el-table-column>
        <el-table-column label="售价（金币）" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.videoSize }}</span>
          </template>
        </el-table-column>
