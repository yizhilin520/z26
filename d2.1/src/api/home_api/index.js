...
// POST /back/move/updateMoveRelated 后台修改影片关联/取关
export function updateMoveRelated(data) {
  return request({
    url: "/move/updateMoveRelated",
    method: "post",
...
// POST /back/move/selectRelationList 后台查询影片关联和取关日志列表
export function selectRelationList(data) {
  return request({
    url: "/move/selectRelationList",
    method: "post",
    data
  });
}
