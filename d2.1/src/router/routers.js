...
export const madouRouterMap = [
  {
    path: "/madou_views",
    component: Layout,
    hidden: false,
    meta: { title: "麻豆首页", icon: "el-icon-s-home", noCache: true },
    name: "麻豆首页",
    redirect: "/madou_views/madou_home",
    alwaysShow: true,
    tabkey: 2,
    children: [
      {
        path: "/madou_views/madou_home",
        component: resolve =>
          require(["@/views/madouViews/madouHome"], resolve),
        name: "MadouHome",
        hidden: false,
        meta: { title: "麻豆", icon: "el-icon-document", noCache: true }
      },
